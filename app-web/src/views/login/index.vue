...
<script>
    ...
    import { goAngleView } from '@/util/common3d';
    export default {
        data() {
        ...
        mounted () {
            ...
            me.$nextTick(()=>{
                ...
                ysc.earthRotation(_viewer, 7000000);//viewer，height:当高度小于多少时，停止展示自转。
                  // 初始视角
                let startViewer = {longitude: 121.897688, latitude: 48.374499, height: 7500000, heading: 0, pitch: -65, roll: 0};
                goAngleView(_viewer, startViewer);
