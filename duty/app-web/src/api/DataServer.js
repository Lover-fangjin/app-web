...
const ajaxPromise = ({ url, type = "get", dataType = "json", data = {f:'pjson'}}) => {
...
const nCovServer = 'https://ncov.earthsdk.comm';

let loadOfflineData = (_name) => {
    $.getJSON("static/json/ncov/"+_name+".json").then(res => { return res; })
}
...
class DataServer {
    ...
    loadScene() {
        return new Promise((resolve, reject) => {
            $.getJSON("static/json/ncov/scene.json").then(res => {
                resolve(res);
            }).catch( error => {
                reject(error);
            });
    ...
    loadNews(p) {
        ...
        return new Promise((resolve, reject) => {
            ...
            ajaxPromise( {url: url} ).then( res => {
                ...
                $.getJSON("static/json/ncov/news.json").then(res => { resolve(res.results); })
                console.log(error);
            });
    ...
    loadArea() {
        return new Promise((resolve, reject) => {
            ...
            ajaxPromise( {url: url} ).then( res => {
                ...
                $.getJSON("static/json/ncov/area.json").then(res => { 
                    process(res);
                })
                console.log(error);
            });
    ...
    loadChinaOverall(ut) {
        return new Promise((resolve, reject) => {
            ...
            ajaxPromise( {url: url} ).then( res => {
                ...
                $.getJSON("static/json/ncov/overall.json").then(res => { 
                    process(res);
                })
                console.log(error);
            });
