<template>
    <div class="wrap flex earth-wrap">
        <div class="center">
            <div id="map3d">
                <div id="earth" class="layout-div"></div>
                <Map class='map'/>
                <Left />
                <TimeLine />
                <News />
...
<style lang="scss" scoped>
  ...
  .layout-div{height:100%; position:absolute; width: 100%}
  .wrap{width:100%;height:100%; min-height: 600px; overflow: hidden;}
  .center{background:#666; height: 100%; position: relative;}
  .right{margin-right:-350px; width:350px;background: $public-background !important; border-left: 1px solid #59d4f775;}
  // .center{background:rgb(105, 73, 73); height: 100%; position: relative;}
  // .right{margin-right:-300px; width:300px;background: #0a1d74!important;}
  .flex {display:flex;display:-webkit-box;display:-moz-box;display:-moz-box;}
  .flex .left{height:100%; }
  .flex .center{-webkit-box-flex:1;box-flex:1;-moz-box-flex:1;}
  .flex .right{height:100%; overflow-y: auto;}
  .flex button{padding:5px;}
    .map{
        left: 15%;
        position: absolute;
        width: 70%;
    ...
    #map3d{
        ...
        height: 100%;
        bottom: 0; right: 0;
        // background: rgb(15, 47, 133);
        background: $public-right-Features;
    }
    // .media{
    //     position: absolute;
    //     right: 18%;
