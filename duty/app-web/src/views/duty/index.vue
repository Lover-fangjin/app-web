...
<script>
    ...
    import {setbaimo, clearAll} from '../earth.js';
    import { drawJsonArea } from '@/util/common3d.js'
    ...
    export default {
        ...
        mounted () {
            ...
            this.$nextTick(()=>{
                ...
                drawJsonArea(viewer, "static/json/duty/bz_area.json", ['一片区', '二片区', '三片区', '四片区', '五片区']).then((entities) => {
                    console.log('片区边界载完成！')
                });
                drawJsonArea(viewer, "static/json/duty/bz_polygon.json", ['北臧村镇']).then((entities) => {
                    console.log('北臧村镇边界载完成！')
