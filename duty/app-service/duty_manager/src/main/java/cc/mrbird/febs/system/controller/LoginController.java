...
import cc.mrbird.febs.common.authentication.UserPhoneToken;
...
public class LoginController extends BaseController {
    ...
    @ResponseBody
    public FebsResponse verificationCodeLogin(
            @RequestParam String phone,
            @RequestParam String verifyCode,
            @RequestParam boolean rememberMe) {
        validateCodeService.checkSms(phone, verifyCode);

        UserPhoneToken token = new UserPhoneToken(phone, rememberMe);
        SecurityUtils.getSubject().login(token);
    ...
    public FebsResponse smsCaptcha(@RequestParam String phone) throws IOException, FebsException {
        boolean flag = validateCodeService.sendSms(phone);
