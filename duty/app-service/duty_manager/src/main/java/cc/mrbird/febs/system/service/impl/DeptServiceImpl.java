...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements IDeptService {
    ...
    @Override
    public IPage<Dept> findDeptDetailList(Dept dept, QueryRequest request) {
        Page<Dept> page = new Page<>(request.getPageNum(), request.getPageSize());
        SortUtil.handlePageSort(request, page, "deptId", FebsConstant.ORDER_ASC, false);
        return this.baseMapper.findDeptDetailPage(page, dept);
    }

    @Override
    public Dept findById(Long deptId) {
        return this.baseMapper.findById(deptId);
    }
}
