...
//        hashedCredentialsMatcher.setHashIterations(5);//散列的次数，md5("")
//        return hashedCredentialsMatcher;
//    }

    @Bean
    public ShiroUserPhoneRealm shiroUserPhoneRealm(){
        ShiroUserPhoneRealm shiroUserPhoneRealm = new ShiroUserPhoneRealm();
        return shiroUserPhoneRealm;
    }
...
//        securityManager.setRealm(shiroRealm);
        ...
        realms.add(shiroUserPhoneRealm());
